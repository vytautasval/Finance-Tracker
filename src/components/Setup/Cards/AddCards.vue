...
import type { Card, Cards } from '@/utilities/types'
...
<template>
  <v-card class="pa-4 bg-yellow-lighten-2">
    <v-card-title> Enter a new card below. </v-card-title>
    <v-card-subtitle class="pb-2"> Insert only the last 4 digits of your card. </v-card-subtitle>
