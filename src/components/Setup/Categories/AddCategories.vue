...
import type { Category, Categories} from '../../usedTypes'
...
<template>
    <v-card class="pa-4 bg-yellow-lighten-2 ">
        <v-card-title>
            Enter a new category below.
        </v-card-title>
        <v-card-subtitle class="pb-2">
            Up to 30 characters.
        </v-card-subtitle>
        <v-form @submit.prevent="addNewCategory">
                <v-text-field label="Create new category.." placeholder="leisure" required v-model="newCategory">
                </v-text-field>
