...
import type { Cards, Categories, Operations } from './types'

/* Filters through cards that are not retired. */
export const filteredCards = (cards: Cards) =>
  computed(() => {
...
export const cardSelection = (cards: Cards) =>
  computed(() => {
...
export const filteredCategories = (categories: Categories) =>
  computed(() => {
...
export const categorySelection = (categories: Categories) =>
  computed(() => {
...
export const filteredOperations = (operations: Operations, currentDate: Date) =>
  computed(() => {
...
export const operationSelection = (operations: Operations, currentDate: Date) =>
  computed(() => {
...
export const totalAmountByCategory = (
